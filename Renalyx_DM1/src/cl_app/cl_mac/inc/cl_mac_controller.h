...
typedef enum {
	...
	EVT_CONSOLE_COMMAND_HEP_PMP_RATE,
	...
	EVT_CONSOLE_COMMAND_HEPARIN_BOLUS,
	EVT_CONSOLE_COMMAND_HEPARIN_START,
	EVT_CONSOLE_COMMAND_HEPARIN_STOP,
	EVT_CONSOLE_COMMAND_CLR_ALARM,
	...
	MACREQ_POST_DIALYSIS_RINSE_REQ,
	MACREQ_POST_DIALYSIS_RINSE_START,
EVT_CONSOLE_COMMAND_ISOUF_START,
EVT_CONSOLE_COMMAND_ISOUF_STOP,
MACREQ_ISOUF_COMPLETED,
EVT_CONSOLE_COMMAND_SET_BLDPUMPINC_MANUAL,
EVT_CONSOLE_COMMAND_SET_BLDPUMPDEC_MANUAL,
EVT_TICK_150M,
MACREQ_POST_DIALYSIS_ISOUF_REQ,
EVT_CONSOLE_COMMAND_MUTE_ALARM,
EVT_CONSOLE_COMMAND_DIALYSIS_ISOUF_ON,
EVT_CONSOLE_COMMAND_DIALYSIS_ISOUF_OFF,

EVT_CONSOLE_COMMAND_SELFTEST_START,
EVT_COSOLE_COMMAND_SELFTEST_ALARM_PAAS,
EVT_COSOLE_COMMAND_SELFTEST_ALARM_FAIL,
MACREQ_SELFTEST_COMPLETED,                                                                        //****************************
EVT_CONSOLE_COMMAND_SELFTEST_STOP,
EVT_CONSOLE_COMMAND_SYNCCONFIRMED,
	EVT_MAX
...
typedef struct  
{
Cl_Uint8Type	Cl_MacNewEventcount;
Cl_BoolType Cl_MacNewEvent;
Cl_Mac_EventsType Cl_MacEvent[MAC_EVENT_COUNT_MAX];
Cl_Uint16Type Cl_MacEventData[MAC_EVENT_COUNT_MAX][MAC_EVENT_DATA_MAX];
	
}Cl_Mac_EventQueueType;
