...
typedef enum
{
	...
	EVENT_RINSE_HEP_PMP_START,
	EVENT_RINSE_HEP_PMP_STOP,
	EVENT_RINSE_HEP_PMP_BLOUS,
...
typedef enum {
	...
	CL_RINSE_ALARM_FPCURRENTSTATUS,                     // Added 17.03.17
	CL_RINSE_ALARM_CONSOLE_SYNC_LOST,                    // added on 18.03.17
CL_RINSE_ALARM_POWER_FAILURE,
CL_RINSE_ALARM_BP_STOPPED,
...
#define CL_RINSE_OPENFILL_TIMEOUT 5
