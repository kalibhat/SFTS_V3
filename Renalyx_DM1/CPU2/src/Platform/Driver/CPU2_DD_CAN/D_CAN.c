...
#include "D_CAN.h"
#include "Platform/Driver/CPU2_DGPIO/GPIO.h"
...
volatile uint32_t  data_count1=0;
...
volatile uint8_t bd_start_calibration = 0 , bp_start_command = 0, bp_stop_command = 0 ,bp_Speed_change_command = 0, bp_inc = 0 , bp_dec = 0;
